...
public final class EbicsSignatureKey extends EbicsRsaKey {
    ...
    @Builder
    private EbicsSignatureKey(final PublicKey publicKey, final SignatureVersion version, final byte[] digest, final Instant creationTime, final PrivateKey privateKey) {
