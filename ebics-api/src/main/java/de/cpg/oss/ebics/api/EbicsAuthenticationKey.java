...
public final class EbicsAuthenticationKey extends EbicsRsaKey {
    ...
    @Builder
    private EbicsAuthenticationKey(final PublicKey publicKey, final AuthenticationVersion version, final byte[] digest, final OffsetDateTime creationTime, final PrivateKey privateKey) {
